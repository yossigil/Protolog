...
public interface Term extends Iterable<Term>, Cloneable {
	...
	default Set<org.spartan.protolog.Term.Atom.Variable> freeVariables() {
	...
	final class Compound extends Symbol implements Term {
		...
		@Override
		public @Nullable Replacement compositeReplacement(final Compound c) {
	...
	public interface Atom extends Term {
		...
		class Variable extends Symbol implements Atom {
			...
			@Override
			public Term replace(final Replacement r) {
		...
		static class Snippet extends Wrapper<String> implements Atom {
			...
			@Override
			public Snippet clone() throws CloneNotSupportedException {
